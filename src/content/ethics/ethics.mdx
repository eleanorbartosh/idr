...
You also need to inform participants of what data is being collected and how it will be used. Data collection should also be done in accordance with GDPR <insert link: https://www.ibm.com/data-responsibility/gdpr/self-assessment/ or https://en.wikipedia.org/wiki/General_Data_Protection_Regulation> and any country-specific requirements. Remember that a participant can refuse or revoke consent at any time.
